...
-----
ALTER TABLE Mon_An ADD
CONSTRAINT FK_Mon_An_Danh_Muc_Chinh FOREIGN KEY(Ma_DM) REFERENCES Danh_Muc_Chinh(Ma_DM)
ALTER TABLE Chi_Tiet_Danh_Muc ADD
CONSTRAINT FK_Chi_Tiet_Danh_Muc_Chi_Nhanh FOREIGN KEY(Ma_CN) REFERENCES Chi_Nhanh(Ma_CN)
ALTER TABLE Chi_Tiet_Danh_Muc ADD
CONSTRAINT FK_Chi_Tiet_Danh_Muc_Danh_Muc_Chinh FOREIGN KEY(Ma_DM) REFERENCES Danh_Muc_Chinh(Ma_DM)
ALTER TABLE Chi_Tiet_Danh_Muc ADD
