...
add constraint PK_CHI_TIET_DON_HANG_DON_HANG
foreign key (IDCTDH)
references CHI_TIET_DON_HANG(IDCTDH),
constraint PK_CHINHANH__DON_HANG
foreign key (IDCHINHANH)
references CHINHANH(ID),
constraint PK_KHAC_HANG__DON_HANG
foreign key (IDKHACHHANG)
references KHACH_HANG(IDKH),
constraint PK_NHAN_VIEN__DON_HANG
foreign key (IDNV)
...
add constraint PK_DANH_SACH_MON_AN__CHI_TIET_DON_HANG
foreign key (IDMONAN)
references DANH_SACH_MON_AN(ID)